...
BEGIN {
    ...
    require '/home/nine9/crypto/openssl-3.4.1/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/nine9/crypto/openssl-3.4.1/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/home/nine9/crypto/openssl-3.4.1/test/default-and-jitter.cnf';
    shift;
